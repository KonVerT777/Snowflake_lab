...
Database made available as: `GLOBAL_WEATHER__CLIMATE_DATA_BY_PELMOREX_WEATHER_SOURCE__`
...
**Result:** Shared database `GLOBAL_WEATHER__CLIMATE_DATA_BY_PELMOREX_WEATHER_SOURCE__` is accessible.
...
1. `GLOBAL_WEATHER` — project schema for weather data
